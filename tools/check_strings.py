...
def getDefinedStrings(filepath):
    ...
    with open(filepath, 'r', encoding="latin-1") as file:
        content = file.read()
        srch = re.compile('Key ID\=\"(STR_Redflashlight_[_a-zA-Z0-9]*)"', re.IGNORECASE)
