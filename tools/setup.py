...
def main():
    ...
    print("""
  ######################################
  # REDFLASHLIGHT Development Environment Setup #
  ######################################

  This script will create your REDFLASHLIGHT dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your REDFLASHLIGHT project folder:
    [Arma 3 installation directory]\\{} => REDFLASHLIGHT project folder
    P:\\{}                              => REDFLASHLIGHT project folder
